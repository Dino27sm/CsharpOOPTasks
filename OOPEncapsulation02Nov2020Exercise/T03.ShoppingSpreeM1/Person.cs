namespace T03.ShoppingSpreeM1
{
    ...
    public class Person
    {
        ...
        internal Person(string namePerson, decimal money)
        {
        ...
        {
            get => this.money;
            set => this.money = value >= 0M ? value : throw new ArgumentException("Money cannot be negative");
        }

        internal bool CanAfordProduct(Product productObject)
        {
            return (this.money - productObject.Cost >= 0M);
        }
